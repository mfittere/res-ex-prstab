...
#if weighted:
## weighted Gaussian
#  opt = '2016injnocolc15o+19_6errb2u%s/1/eps3.5/hv9_6e-8/p1e4t1e2s100weight'%sk
#else:
## normal Gaussian
#  opt = '2016injnocolc15o+19_6errb2u%s/1/eps3.5/hv9_6e-8/p1e4t1e2s100'%sk
#
#close('all')
...
if weighted:
# weighted Gaussian
  opt = '2016injnocolc15o+19_6errb2u/1/eps3.5/p1e4t1e2s100weight'
else:
# normal Gaussian
  opt = '2016injnocolc15o+19_6errb2u/1/eps3.5/p1e4t1e2s100'
close('all')
t=LifeDeskDB.getdata(ltr_dir=os.path.join(basedir,opt),plt_dir=plt_dir)
t.get_hist()
