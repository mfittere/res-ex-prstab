...
optsk = "2017injnocolc15o+19_6erra2b2ut8skran/1/eps3.5/%s%se-8ran1_2e-3/p1e4t1e4s100weight"
...
for phv,p12 in zip(['hor.','vert.'],'12'):
  ...
  leg = plt.legend(title='excitation\n8th turn',ncol=1,fontsize=12)
  plt.setp(leg.get_title(),fontsize=12)
  plt.savefig(os.path.join(plt_dir,'2017injerra2b2uran1_2e-3_8th_3_5um_emit%s.png'%p12),bbox_inches='tight')
...
for phv,p12 in zip(['hor.','vert.'],'12'):
  ...
  leg = plt.legend(title='excitation\n8th turn',ncol=1,fontsize=12)
  plt.setp(leg.get_title(),fontsize=12)
  plt.savefig(os.path.join(plt_dir,'2017injerra2b2uran1_2e-3_8th_3_5um_rel_emit%s.png'%p12),bbox_inches='tight')
