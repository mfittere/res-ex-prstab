...
opt0ran = "2016injnocolc15o+19_6erra2b2uran/1/eps3.5/1_2e-3/p1e4t1e4s100weight"
# random noise + 10th V pulsing
optskran = "2016injnocolc15o+19_6erra2b2ut10skran/1/eps3.5/v%se-8ran1_2e-3/p1e4t1e4s100weight"
# 10th V pulsing
optsk    = "2016injnocolc15o+19_6erra2b2ut10sk/1/eps3.5/v%se-8/p1e4t1e4s100weight"
...
f = open(os.path.join(basedir,'2016injnocolc15o+19_6erra2b2ut10skran/1/eps3.5/','losses_ran_10V'), 'w+')
...
for param,paramfig in zip(params,paramsfig):
  ...
  plt.savefig(os.path.join(plt_dir,'2016injerra2b2uran1_2e-3_10thV_3_5um_%s.png'%param),bbox_inches='tight')
