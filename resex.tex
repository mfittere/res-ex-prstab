...
\begin{figure}[h]
	\begin{minipage}[t]{0.49\linewidth}
		\centering
		reference bunch,\\ no excitation
		\includegraphics[width=1.0\linewidth]{profile_hv7th_slot_2862.png}
	\end{minipage}
	\begin{minipage}[t]{0.49\linewidth}
		\centering
		excited bunch,\\ $7^{\mathrm{th}}$~turn h+V		\includegraphics[width=1.0\linewidth]{profile_hv7th_slot_2696.png}
	\end{minipage}
...
Pulsing patterns which have little effect on the beam core are particularly interesting for the hollow electron lens operation. With this motivation in mind the $8^{\mathrm{th}}$ turn pulsing pattern was studied, for which a small effect is expected in comparison to the $7^{\mathrm{th}}$ and $10^{\mathrm{th}}$ turn pulsing. In the Distribution Tracking, the excitation amplitudes had to be increased to 96~nrad to have a visible effect
