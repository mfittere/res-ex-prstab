...
\begin{figure}[h]
		\centering
		\includegraphics[width=1.0\linewidth]{scale_amp_10v_ran_10V_sim.png}
...
The $7^{\mathrm{th}}$~turn pulsing pattern is the only pulsing pattern which has been tested during both experiments in 2016 and 2017 and was intended to serve as a proof for the reproducibility of the results. However, in 2017 the machine tune was changed from (64.28,59.31) to (62.27,60.295) in standard operation accompanied by a slight change in optics. The attempt to change back to the fractional tune of (.28,.31) as chosen in 2016 however lead to large losses during the experiments in 2017. This change in tune entailed a change in the driving resonances, from previously the $7Q_x$ resonances in 2016  (Fig.~\ref{fig:patternfma}) to the $7Q_x$, $7Q_y$ and $7Q_x + 7Q_y$ resonance in 2017 (Fig.~\ref{fig:7th2017fma}) and in addition also the effected amplitudes of the beam distribution.
\begin{figure}[h]
	\begin{minipage}[t]{0.49\linewidth}
		\centering
		no excitation
...
\end{figure}
Therefore the effects on the beam also differ for both experiments (see Table~\ref{tab:7thexp} for a general overview and Fig.~\ref{} and Appendix~\ref{} for more details).
\begin{table}[h]
