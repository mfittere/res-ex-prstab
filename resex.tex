...
\begin{figure}[h]
\includegraphics[width=\columnwidth]{CHG1b_170512_8p75A_2-4-2p7kG_500V_76mA_hires_Emap}
...
\caption{Calculated relative electric field for the hollow electron
  gun in the transverse $x$-$y$ plane (left) and as 1-dimensional cuts
  through the $x$ and $y$ axes (right). The field calculations are
  based on measurements at the Fermilab electron-lens test stand
  combined with Warp calculations of the electric potentials and
  fields in a cylindrical beam pipe.}
\label{core:fig:1}
\end{figure}
