...
\begin{equation}
	\Delta x'_{\rm{central \ region}}, \Delta y'_{\rm{central \ region}} \approx \SI{19.6}{nrad} % this should be rounded to the same number of digits as the 0.5nrad
\end{equation}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{2016+2017_scale_amp_7h_lblshort.png}
...
\begin{figure}[h]
	\begin{minipage}[t]{1.0\linewidth}
	\centering
	\includegraphics[width=0.8\linewidth]{2017_scale_amp_7h_lblshort.png}
	\end{minipage}
	\begin{minipage}[t]{1.0\linewidth}
		\centering
		\includegraphics[width=0.8\linewidth]{2017_scale_amp_7v_lblshort.png}
	\end{minipage}
	\begin{minipage}[t]{1.0\linewidth}
		\centering
		\includegraphics[width=0.8\linewidth]{2017_scale_amp_7hv_lblshort.png}
	\end{minipage}
