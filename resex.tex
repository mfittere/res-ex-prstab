...
\begin{figure*}
	...
	\caption{\label{fig:fill} Filling and excitation scheme for LHC experiments in 2017.}
\end{figure*}
...
\begin{figure}
	...
	\caption{\label{fig:fill_meas} Excitation amplitude in horizontal and vertical measured during the 2017 experiment during the $8^{\mathrm{th}}$~turn pulsing.}
\end{figure}
